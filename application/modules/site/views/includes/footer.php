...
<script src="<?php echo site_url();?>assets/themes/adore/http://maps.googleapis.com/maps/api/js?sensor=false"></script>
<script src="<?php echo site_url();?>assets/themes/adore/style-switcher/js/jquery_cookie.js"></script>
<script src="<?php echo site_url();?>assets/themes/adore/style-switcher/js/script.js"></script>
