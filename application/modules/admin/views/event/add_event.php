                	...
                	<div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div id="datetimepicker_start" class="input-append">
                            	<input data-format="yyyy-MM-dd hh:mm:ss" type="text" class="form-control" name="event_start_time" placeholder="Event start date" value="<?php echo set_value("event_start_time");?>">
                        ...
                        <div class="form-group">
                            ...
                            <div id="datetimepicker_end" class="input-append">
                            	<input data-format="yyyy-MM-dd hh:mm:ss" type="text" class="form-control" name="event_end_time" placeholder="Event end date" value="<?php echo set_value("event_end_time");?>">
                                <span class="add-on" style="cursor:pointer;">
                                    &nbsp;<i data-time-icon="icon-time" data-date-icon="icon-calendar">
                                    </i>
                                </span>
