...
{	
	...
	*
	*/
	public function get_recent_posts($limit = 3)
	{
		$this->db->select('post.*, blog_category.blog_category_name');
		$this->db->where('post_status = 1  AND post.blog_category_id = blog_category.blog_category_id AND blog_category.blog_category_name = "Blog"' );
		$this->db->order_by('created', 'DESC');
